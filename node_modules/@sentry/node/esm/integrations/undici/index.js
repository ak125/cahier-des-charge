...
import { getCurrentHub, getClient, isSentryRequestUrl, getCurrentScope, getActiveSpan, getDynamicSamplingContextFromSpan, spanToTraceHeader, getDynamicSamplingContextFromClient, addBreadcrumb } from '@sentry/core';
...
function createRequestSpan(
  ...
  return _optionalChain([activeSpan, 'optionalAccess', _ => _.startChild, 'call', _2 => _2({
    op: 'http.client',
