...
function normalizeOptions(options: TemporalWorkflowGeneratorSchema): NormalizedSchema {
...
export default async function (tree: Tree, options: TemporalWorkflowGeneratorSchema) {
  ...
  generateFiles(tree, path.join(__dirname, 'files'), normalizedOptions.projectDirectory, {
    ...normalizedOptions,
    template: '',
  });
