...
BACKUP_COUNT=$(find /workspaces/cahier-des-charge -type f \( -name "*.bak*" -o -name "*.backup*" -o -name "*.merged*" -o -name "*.orig" -o -name "*~" \) | wc -l)
...
find /workspaces/cahier-des-charge -type f \( -name "*.bak*" -o -name "*.backup*" -o -name "*.merged*" -o -name "*.orig" -o -name "*~" \) -exec rm -f {} \;

# Vérification après suppression
REMAINING=$(find /workspaces/cahier-des-charge -type f \( -name "*.bak*" -o -name "*.backup*" -o -name "*.merged*" -o -name "*.orig" -o -name "*~" \) | wc -l)
