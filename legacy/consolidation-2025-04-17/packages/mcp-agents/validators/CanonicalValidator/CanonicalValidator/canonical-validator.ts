import { AbstractValidatorAgent } from '../AbstractValidator';
/**
...
export class CanonicalValidator extends AbstractValidatorAgent<any, any> implements MCPAgent<CanonicalValidatorConfig> {
