 ...
 * /workspaces/cahier-des-charge/packages/core/interfaces/orchestration/scheduler-agent.ts
 * 
 * Migré le 2025-05-08
 */

import { SchedulerAgent } from '@core/interfaces/orchestration/scheduler-agent';
