...
if (require.main === module) {
  ...
  if (args.length < 2) {
    ...
    console.error('Exemple: ts-node QaAnalyzer.ts ./src/fiche.php \'{"component":"./app/routes/fiche.tsx","loader":"./app/routes/fiche.loader.ts","meta":"./app/routes/fiche.meta.ts"}\'');
    process.exit(1);
  }
