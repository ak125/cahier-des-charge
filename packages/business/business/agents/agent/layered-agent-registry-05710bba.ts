...
import {
  ...
  ParserAgent,
  ValidatorAgent,
} from './interfaces/businessstructure-agent';
import { AdapterAgent, BridgeAgent, RegistryAgent } from './interfaces/coordinationstructure-agent';
import {
  MonitorAgent,
  OrchestratorAgent,
  SchedulerAgent,
} from './interfaces/orchestrationstructure-agent';
