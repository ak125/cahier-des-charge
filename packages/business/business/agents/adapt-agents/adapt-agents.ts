...
import * as readline from 'readlinestructure-agent';
...
async function generateAgentTemplate(
  ...
  template += `import { ${agentType.abstractClass}, ${agentType.configInterface} } from '${agentType.abstractClassPath}structure-agent'\n`;
  template += `import { AgentContext } from '../../coreDoDotmcp-agentstructure-agent'\n\n`;
