...
export class migration-orchestrator-agent-02f58fee implements OrchestratorAgent {
  id = 'migration-orchestrator-agent-02f58fee-001';
  name = 'migration-orchestrator-agent-02f58fee';
  type = 'orchestrator';
  version = '1.0.0';
