...
export class seo-redirect-mapper-agent-28b31273 implements BusinessAgent {
  id = 'seo-redirect-mapper-agent-28b31273-001';
  name = 'seo-redirect-mapper-agent-28b31273';
  type = 'business';
  version = '1.0.0';
