...
export class progressive-migration-agent-33a56704-90744e9a implements BusinessAgent {
  id = 'progressive-migration-agent-33a56704-90744e9a-001';
  name = 'progressive-migration-agent-33a56704-90744e9a';
  type = 'business';
  version = '1.0.0';
