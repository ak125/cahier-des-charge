...
export class postgresql-validator-agent-076bd659 implements ValidatorAgent {
  id = 'postgresql-validator-agent-076bd659-001';
  name = 'postgresql-validator-agent-076bd659';
  type = 'validator';
  version = '1.0.0';
