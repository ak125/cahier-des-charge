...
export class table-cartographer-agent-454dcdff-a9aeece6 implements BusinessAgent {
  id = 'table-cartographer-agent-454dcdff-a9aeece6-001';
  name = 'table-cartographer-agent-454dcdff-a9aeece6';
  type = 'business';
  version = '1.0.0';
