...
export class php-analyzer-v3-agent-0869c227-713d8d73 implements AnalyzerAgent {
  id = 'php-analyzer-v3-agent-0869c227-713d8d73-001';
  name = 'php-analyzer-v3-agent-0869c227-713d8d73';
  type = 'analyzer';
  version = '1.0.0';
