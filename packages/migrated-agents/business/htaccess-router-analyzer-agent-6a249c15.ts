...
export class htaccess-router-analyzer-agent-6a249c15 implements AnalyzerAgent {
  id = 'htaccess-router-analyzer-agent-6a249c15-001';
  name = 'htaccess-router-analyzer-agent-6a249c15';
  type = 'analyzer';
  version = '1.0.0';
