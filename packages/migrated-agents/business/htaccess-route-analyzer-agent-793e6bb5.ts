...
export class htaccess-route-analyzer-agent-793e6bb5 implements AnalyzerAgent {
  id = 'htaccess-route-analyzer-agent-793e6bb5-001';
  name = 'htaccess-route-analyzer-agent-793e6bb5';
  type = 'analyzer';
  version = '1.0.0';
