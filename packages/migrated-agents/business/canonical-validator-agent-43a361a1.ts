...
export class canonical-validator-agent-43a361a1 implements ValidatorAgent {
  id = 'canonical-validator-agent-43a361a1-001';
  name = 'canonical-validator-agent-43a361a1';
  type = 'validator';
  version = '1.0.0';
