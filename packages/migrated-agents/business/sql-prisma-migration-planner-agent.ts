...
export class sql-prisma-migration-planner-agent implements BusinessAgent {
  id = 'sql-prisma-migration-planner-agent-001';
  name = 'sql-prisma-migration-planner-agent';
  type = 'business';
  version = '1.0.0';
