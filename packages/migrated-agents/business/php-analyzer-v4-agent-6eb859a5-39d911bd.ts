...
export class php-analyzer-v4-agent-6eb859a5-39d911bd implements AnalyzerAgent {
  id = 'php-analyzer-v4-agent-6eb859a5-39d911bd-001';
  name = 'php-analyzer-v4-agent-6eb859a5-39d911bd';
  type = 'analyzer';
  version = '1.0.0';
