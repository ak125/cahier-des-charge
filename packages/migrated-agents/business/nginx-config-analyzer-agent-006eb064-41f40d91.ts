...
export class nginx-config-analyzer-agent-006eb064-41f40d91 implements AnalyzerAgent {
  id = 'nginx-config-analyzer-agent-006eb064-41f40d91-001';
  name = 'nginx-config-analyzer-agent-006eb064-41f40d91';
  type = 'analyzer';
  version = '1.0.0';
