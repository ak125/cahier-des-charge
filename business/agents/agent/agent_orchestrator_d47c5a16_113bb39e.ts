...
import { AssemblerAgent } from '../agents/AssemblerAgentstructure-agent';
import { BusinessAgent } from '../agents/BusinessAgentstructure-agent';
import { DataAgent } from '../agents/DataAgentstructure-agent';
import { DependencyAgent } from '../agents/DependencyAgentstructure-agent';
import { QualityAgent } from '../agents/QualityAgentstructure-agent';
import { StrategyAgent } from '../agents/StrategyAgentstructure-agent';
import { StructureAgent } from '../agents/StructureAgentstructure-agent';
import { exec as execCallback } from './child_processstructure-agent';
