...
// PrismaGenerator implementation
export class PrismaGenerator
  implements McpAgent, BaseAgent, BusinessAgent, GeneratorAgent, AnalyzerAgent {
  readonly metadata: AgentMetadata = {
    id: 'index',
    type: 'analyzer',
    name: 'PrismaGenerator',
    version: '1.0.0',
    description: 'Automatically fixed version of PrismaGenerator',
  };
  ...
  async initialize(): Promise<void> {
    ...
    console.log('PrismaGenerator initialized');
  }
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing PrismaGenerator with context: ${JSON.stringify(context)}`);
      ...
      // Résultat fictif
      const results = {
        message: 'PrismaGenerator executed successfully',
...
import {
  BusinessAgent,
  GeneratorAgent,
} from '@workspaces/migration-ai-pipeline/src/core/interfaces/business';

import { AnalyzerAgent } from '@workspaces/migration-ai-pipeline/src/core/interfaces/business';
