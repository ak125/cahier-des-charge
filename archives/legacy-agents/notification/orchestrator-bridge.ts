 ...
 * 
 * Ce pont d'orchestration pour notifications fait partie des orchestrateurs personnalisés 
 * qui doivent être migrés vers l'implémentation standardisée selon 
 * le document /docs/technologies-standards.md.
 * 
 * PLAN DE MIGRATION:
 * - Pour les notifications, utiliser la file BullMQ standardisée: /packages/business/queue/
 * 
