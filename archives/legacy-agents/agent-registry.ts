...
import { BaseAgent } from './src/core/interfaces/base-agent';
import {
  AnalyzerAgent,
  GeneratorAgent,
  ParserAgent,
...
import { MCPManifestManager } from './agentsdot-mcp-manifest-manager';
import { UrlPreservationAgent } from './seo/url-preservation-agent';
...
// Agent pour préserver les URLs PHP sans redirection
export const urlPreservationAgent = new UrlPreservationAgent();
