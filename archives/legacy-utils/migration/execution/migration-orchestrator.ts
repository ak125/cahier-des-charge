...
import { readCahierDesCharges } from './agents/AgentAuditstructure-agent';
import { CoordinatorAgent } from './agents/CoordinatorAgentstructure-agent';
          ...
          if (options.showMetrics) {
            ...
            results.forEach((r) => {
              ...
              console.log(
                `${status} ${chalk.bold(
                  r.agentName
                )}: ${time}ms, ${itemsProcessed} éléments traités`
              );
            });
          }
        },
