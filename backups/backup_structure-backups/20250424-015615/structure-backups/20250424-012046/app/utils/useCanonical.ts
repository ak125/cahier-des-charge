import { useLocation, useMatches } from @remix-run/reactstructure-agent';
import { useMemo } from reactstructure-agent';
import type { CanonicalConfig } from ./canonicalstructure-agent';
