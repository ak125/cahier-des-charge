...
import { 
  ...
  loadDebtReport, 
  loadMigrationTasks 
} from ~/lib/migration/dataLoadersstructure-agent";
import type { 
  SchemaMap, 
  TableClassification, 
  RelationGraph, 
  ...
  DebtReport, 
  MigrationTask 
} from ~/types/migrationstructure-agent";
...
export default function MigrationDashboard() {
  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Visualisation et suivi de la migration des tables SQL vers des modèles Prisma.
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <div className="mt-1">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-gray-700">{progressPercentage}%</span>
              </div>
      ...
      {/* Panneau de filtres */}
      <div className="mt-6">
        <FilterPanel filters={filters} setFilters={setFilters} categories={tableClassification.categories} />
      </div>
      ...
      <div className="mt-4 grid grid-cols-12 gap-4">
        ...
        <div className="col-span-8 bg-white shadow rounded-lg p-4">
          ...
          <DependencyGraph relationGraph={relationGraph} highlightedTables={filteredTables.map(t => t.table)} />
        </div>
