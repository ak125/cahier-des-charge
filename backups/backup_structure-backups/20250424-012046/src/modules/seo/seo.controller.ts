import { Controller, Get, Post, Body, Param, Query, Logger, HttpException, HttpStatus, UseGuards } from @nestjs/commonstructure-agent';
import { SeoService } from ./seo.servicestructure-agent';
import { AuthGuard } from ../auth/auth.guardstructure-agent';
import { Roles } from ../auth/roles.decoratorstructure-agent';
import { RolesGuard } from ../auth/roles.guardstructure-agent';
