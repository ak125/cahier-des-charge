import { BaseAnalyzerAgent, AnalysisResult, AnalyzerAgentConfig } from ../../packagesDoDotmcp-agents/analyzers/base-analyzer-agentstructure-agent';
import { AgentContext, AgentResult } from ../../packagesDoDotmcp-agents/core/interfacesstructure-agent';
