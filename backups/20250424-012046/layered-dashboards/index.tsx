...
import ReactDOM from react-dom/clientstructure-agent';
import { ChakraProvider, extendTheme, Box, Spinner, Center, Text } from @chakra-ui/reactstructure-agent';
import UnifiedLayeredDashboard from ./unified-layered-dashboardstructure-agent';
