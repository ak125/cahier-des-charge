...
import type { MetaFunction, LinksFunction } from @remix-run/reactstructure-agent'
import { createSEOMeta, createSEOLoader } from ~/utils/seostructure-agent'
import { createCanonicalLink } from ~/utils/useCanonicalstructure-agent'
