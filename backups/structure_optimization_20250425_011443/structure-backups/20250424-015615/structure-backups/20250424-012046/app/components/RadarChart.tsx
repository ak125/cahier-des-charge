...
import { Chart as ChartJS, RadialLinearScale, PointElement, LineElement, Filler, Tooltip, Legend } from chart.jsstructure-agent';
import { Radar } from react-chartjs-2structure-agent';
