import { Body, Controller, Delete, Get, Param, Patch, Post } from @nestjs/commonstructure-agent';
import { ApiBody, ApiOperation, ApiParam, ApiResponse, ApiTags } from @nestjs/swaggerstructure-agent';
import { ProductService } from ./product.servicestructure-agent';
import { 
  ProductCreateSchema, 
  ProductUpdateSchema, 
  ProductCreate, 
  ProductUpdate, 
  Product 
} from @schemas/zod-schemasstructure-agent';
import { ZodValidationPipe, createZodDto, UseZodValidation } from @nestjs/zod-validationstructure-agent';
