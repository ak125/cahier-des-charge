...
import { 
  ...
  CircuitEvent,
  CircuitState
} from ./base-circuit-breakerstructure-agent';
import { configManager } from ../../config/core/unified-configstructure-agent';
import { TraceabilityService } from ../traceability/traceability-servicestructure-agent';
