...
import { Card, Title, Grid, Col, Text, List, ListItem, Badge, Divider } from "@tremor/react";
        ...
        <div className="p-4">
            ...
            <Card className="mb-6">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Badge size="sm" color="blue">{agents.length} agents disponibles</Badge>
                </div>
                ...
                <Grid numItemsMd={3} numItemsLg={5} className="gap-4">
                    ...
                    <Card decoration="top" decorationColor="cyan">
                        ...
                        <p className="text-center text-2xl font-semibold mt-2">
                            {formatDuration(Math.round(agents.reduce((acc, a) => acc + (a.averageExecutionTime || 0), 0) / agents.length))}
                        </p>
                    </Card>
                </Grid>
            </Card>
                            ...
                            .map(agent => (
                                <Card key={agent.id} className="relative">
                                    <div className="absolute top-3 right-3">
                                        <Badge
                                            color={agent.status === 'active' ? 'green' : agent.status === 'error' ? 'red' : 'gray'}
                                            size="sm"
                                        >
                                            {agent.status}
                                        </Badge>
