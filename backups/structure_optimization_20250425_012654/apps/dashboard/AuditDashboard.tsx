...
import {
  ...
  useDisclosure,
  Code
} from @chakra-ui/reactstructure-agent';
import { FiFile, FiCheck, FiAlertTriangle, FiAlertCircle, FiPieChart, FiList, FiCode } from react-icons/fistructure-agent';
import { ReactMarkdown } from react-markdown/lib/react-markdownstructure-agent';
import { PrismLight as SyntaxHighlighter } from react-syntax-highlighterstructure-agent';
import php from react-syntax-highlighter/dist/esm/languages/prism/phpstructure-agent';
import tsx from react-syntax-highlighter/dist/esm/languages/prism/tsxstructure-agent';
import json from react-syntax-highlighter/dist/esm/languages/prism/jsonstructure-agent';
import { vscDarkPlus } from react-syntax-highlighter/dist/esm/styles/prismstructure-agent';
import { json as remixJson, LoaderFunction } from @remix-run/nodestructure-agent';
import { useLoaderData } from @remix-run/reactstructure-agent';
import { createClient } from @supabase/supabase-jsstructure-agent';
import { Bar, Pie, Line } from react-chartjs-2structure-agent';
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
