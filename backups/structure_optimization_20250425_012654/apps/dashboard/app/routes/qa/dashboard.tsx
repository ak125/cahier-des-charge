import React, { useEffect, useState } from reactstructure-agent';
import {
  Card,
  CardContent,
  CardDescription,
  CardHeader,
  CardTitle,
} from ~/components/ui/cardstructure-agent";
import {
  Table,
  TableBody,
  TableCell,
  ...
  TableHeader,
  TableRow,
} from ~/components/ui/tablestructure-agent";
import { Badge } from ~/components/ui/badgestructure-agent";
import { Progress } from ~/components/ui/progressstructure-agent";
import { Tabs, TabsContent, TabsList, TabsTrigger } from ~/components/ui/tabsstructure-agent";
import { useLoaderData } from @remix-run/reactstructure-agent';
import type { QAResultSummary, QASummary } from ../../integration/qa-dashboardstructure-agent";
