...
import type { TemporalJob, JobStatistics } from ~/models/job.serverstructure-agent';
import { getRecentTemporalJobs, getTemporalJobStatistics } from ~/models/job.serverstructure-agent';
import JobStatusCard from ./JobStatusCardstructure-agent';
  ...
  return (
    <div className="job-status-dashboard">
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-4 border-l-4 border-yellow-500">
            ...
            <div className="text-2xl font-bold">{jobCountByStatus.running + jobCountByStatus.pending}</div>
            <div className="text-xs text-gray-500 mt-1">
          ...
          <div className="bg-white rounded-lg shadow p-4 border-l-4 border-red-500">
            ...
            <div className="text-xs text-gray-500 mt-1">
              {Math.round((stats.workflowsFailed / (stats.workflowsStarted || 1)) * 100)}% des workflows
            </div>
          </div>
        </div>
      )}
      ...
      <div className="flex justify-between items-center text-xs text-gray-500">
        ...
        {autoRefresh && (
          <span>Actualisation automatique toutes les 10 secondes</span>
        )}
      </div>
    </div>
  );
