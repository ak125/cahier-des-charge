...
import { PhpAnalysisResult, AgentResult, MigrationConfig, DataStructure } from ../typesstructure-agent';
...
export class NestJSGenerator {
  ...
  private generateController(moduleName: string, dataStructure: DataStructure): string {
    ...
    return `import { Controller, Get, Post, Body, Patch, Param, Delete, Query } from @nestjs/commonstructure-agent';
import { ApiTags, ApiOperation, ApiResponse } from @nestjs/swaggerstructure-agent';
import { ${entityName}Service } from ./${moduleName}.servicestructure-agent';
import { Create${entityName}Dto, Update${entityName}Dto, Find${entityName}Dto } from ./${moduleName}.dtostructure-agent';
...
export class ${entityName}Controller {
  ...
  private generateService(moduleName: string, dataStructure: DataStructure, analysisResult: PhpAnalysisResult): string {
    ...
    return `import { Injectable, NotFoundException } from @nestjs/commonstructure-agent';
import { PrismaService } from ../../prisma/prisma.servicestructure-agent';
import { Create${entityName}Dto, Update${entityName}Dto, Find${entityName}Dto } from ./${moduleName}.dtostructure-agent';
...
export class ${entityName}Service {
  ...
  ${name}${required ? '' : '?'}: ${this.mapPhpTypeToTypeScript(type)};`;
    ...
    return `import { IsString, IsNumber, IsBoolean, IsDate, IsOptional, IsEnum, IsArray } from class-validatorstructure-agent';
import { ApiProperty, ApiPropertyOptional } from @nestjs/swaggerstructure-agent';
import { Type } from class-transformerstructure-agent';
...
import { ${entityName}Service } from ./${moduleName}.servicestructure-agent';
import { ${entityName}Controller } from ./${moduleName}.controllerstructure-agent';
import { PrismaService } from ../../prisma/prisma.servicestructure-agent';
