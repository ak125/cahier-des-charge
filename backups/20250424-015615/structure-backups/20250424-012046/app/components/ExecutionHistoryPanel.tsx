...
import type { ExecutionHistoryEntry, TemporalJob } from ~/models/job.serverstructure-agent';
import { getJobExecutionHistory, getUpcomingScheduledExecutions } from ~/models/job.serverstructure-agent';
