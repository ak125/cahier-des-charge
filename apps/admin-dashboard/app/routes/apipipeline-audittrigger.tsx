...
export const action: ActionFunction = async ({ request }) => {
  ...
  try {
    ...
    await execAsync(
      `mkdir -p public/data/pipeline-audit && cp ../../status-audit-report.json public/data/pipeline-audit/ && cp ../../trace-verification-report.json public/data/pipeline-audit/ && echo '{"lastUpdated":"${new Date().toISOString()}"}' > public/data/pipeline-audit/last-update.json`
    );
