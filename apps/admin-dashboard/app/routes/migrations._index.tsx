...
import type { Agent, Migration } from '../types';
...
export default function MigrationsDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'migrations' | 'agents' | 'logs' | 'graph'>(
    'migrations'
  );
  const [_selectedMigration, setSelectedMigration] = useState<Migration | null>(null);
                      ...
                      <div className="flex items-center">
                        ...
                        <span
                          className={`font-medium ${
                            migration.qaScore > 80
                              ? 'text-green-700'
                              : migration.qaScore > 60
                                ? 'text-yellow-700'
                                : 'text-red-700'
                          }`}
                        >
                          {migration.qaScore}/100
                        </span>
                      </div>
                    )}
                    {migration.seoScore && (
                      <div className="flex items-center">
                        ...
                        <span
                          className={`font-medium ${
                            migration.seoScore > 80
                              ? 'text-green-700'
                              : migration.seoScore > 60
                                ? 'text-yellow-700'
                                : 'text-red-700'
                          }`}
                        >
                          {migration.seoScore}/100
                        </span>
                      </div>
                    )}
                  </td>
              ...
              {agents.map((agent) => (
                <tr key={agent.name} className="hover:bg-gray-50">
                  ...
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                    ...
                    {agent.error && <div className="text-xs text-red-500 mt-1">{agent.error}</div>}
                  </td>
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                  ...
                  <td className="whitespace-nowrap px-3 py-4 text-sm font-medium">
                    <div className="flex space-x-2">
                      ...
                      <button className="px-2 py-1 text-xs text-gray-600 hover:text-gray-900 bg-gray-50 rounded">
                        Logs
                      </button>
                    </div>
                  </td>
        ...
        <div className="mb-6">
          ...
          <div className="mt-4 bg-gray-50 p-4 rounded-lg">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center">
                <span className="inline-block w-3 h-3 rounded-full bg-[#6366f1] mr-2" />
              ...
              <div className="flex items-center">
                <span className="inline-block w-3 h-3 rounded-full bg-[#f59e0b] mr-2" />
                <span className="text-sm">Agent</span>
              </div>
              <div className="flex items-center">
                <span className="inline-block w-3 h-3 rounded-full bg-[#ef4444] mr-2" />
              ...
              <div className="flex items-center">
                <span className="inline-block w-3 h-3 rounded-full bg-[#3b82f6] mr-2" />
