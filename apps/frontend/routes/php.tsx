    ...
    <div className="legacy-page-container">
      <div className="legacy-page-content">
        ...
        <div className="legacy-page-message">
          <p>
            La page que vous recherchez n'est plus disponible ou a été déplacée vers une nouvelle
            adresse.
          </p>
          ...
          {data.isPhp && (
            <div className="legacy-php-notice">
              ...
              <p>
                L'URL <code>{data.path}</code> n'est plus active.
              </p>
            </div>
          )}
        ...
        <div className="legacy-page-help">
          <h3>Besoin d'aide?</h3>
          <p>
            Si vous pensez qu'il s'DoDoDoDotgit d'une erreur ou si vous cherchez un contenu
