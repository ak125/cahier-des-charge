...
import { type Product, ProductCreateSchema, ProductSchema } from '@schemas/zod-schemas';
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    return json(
      {
        status: 'error',
        error: { message: "Une erreur s'est produite lors de la création du produit" },
        submission,
      },
      { status: 500 }
    );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="flex items-center">
                <input {...conform.input(fields.isActive, { type: 'checkbox' })} className="mr-2" />
