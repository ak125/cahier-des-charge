...
export class BullQueueService {
   ...
   */
  async clearQueue(queueName: 'php-analyzer' | 'js-analyzer' | 'migration' | 'verification') {
    let queue: Queue;
   ...
   */
  async getQueueStats(queueName: 'php-analyzer' | 'js-analyzer' | 'migration' | 'verification') {
    let queue: Queue;
  ...
  async getAllQueuesStats() {
    const [phpStats, jsStats, migrationStats, verificationStats] = await Promise.all([
      this.getQueueStats('php-analyzer'),
