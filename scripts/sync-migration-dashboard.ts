...
import syncMigrationStatus from '../app/lib/migration/sync_migration_status';
...
if (!process.env.SUPABASE_URL || !process.env.SUPABASE_ANON_KEY) {
  ...
  console.error(
    '  SUPABASE_URL=https://votre-projet.supabase.co SUPABASE_ANON_KEY=votre-clé-supabase npm run sync-migration'
  );
  process.exit(1);
}
