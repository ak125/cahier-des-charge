...
2. **Examiner la structure actuelle du fichier**
   - S'agit-il d'une classe, d'un objet, d'une fonction ?
...
import { PhpAnalysisResult } from '../../analyzers/php-analyzer/php-analyzer-v2';
...
cp /workspaces/cahier-des-charge/scripts/manual-migration-templates.ts /workspaces/cahier-des-charge/packages/mcp-agents/analyzers/my-analyzer-v2.ts
\`\`\`
