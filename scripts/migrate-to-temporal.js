...
const { BullMQAdapter, TemporalAdapter, OrchestratorType, orchestrationService } = require('../src/orchestration/orchestrator-adapter');
...
async function updateApplicationCode() {
    ...
    try {
        ...
        const findCmd = 'find . -type f -name "*.js" -o -name "*.ts" | grep -v node_modules | xargs grep -l "bullmq\\|@nestjs/bullmq" || true';
