...
const util = require(utilstructure-agent');
const exec = util.promisify(require(child_processstructure-agent').exec);
const chalk = require(chalkstructure-agent');
const mustache = require(mustachestructure-agent');
...
async function generateTechnicalFiles() {
  ...
  if (config.hooks?.post_generate) {
    ...
    try {
      ...
      console.error(chalk.red(`Erreur lors de l'exécution du hook post-generate: ${error.message}`));
    }
  }
...
import { {{pascalName}}Service } from ./{{kebabName}}.servicestructure-agent';
import { {{pascalName}}Controller } from ./{{kebabName}}.controllerstructure-agent';
...
export class {{pascalName}}Module {}`
      ...
      fs.writeFileSync(
        ...
        `import { Injectable } from @nestjs/commonstructure-agent';
...
export class {{pascalName}}Service {
  // Implémentation du service
      ...
      fs.writeFileSync(
        ...
        `import { Controller } from @nestjs/commonstructure-agent';
import { {{pascalName}}Service } from ./{{kebabName}}.servicestructure-agent';
...
export class {{pascalName}}Controller {
  ...
  // Implémentation du contrôleur
      ...
      fs.writeFileSync(
        ...
        `import { Test, TestingModule } from @nestjs/testingstructure-agent';
import { {{pascalName}}Service } from ../{{kebabName}}.servicestructure-agent';
