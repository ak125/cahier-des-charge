...
export const orchestratorAgent = {
  ...
  optimizeAgentsOrder(agents: any[], metrics: Record<string, AgentPerformanceMetrics>, logs: string[]): void {
    ...
    const dependencies: Record<string, string[]> = {
      'diff-verifier': [],  // Pas de dépendances
      'dev-linter': [],     // Pas de dépendances
      'dev-checker': ['dev-linter'],  // Dépend de dev-linter
      'dev-integrator': ['diff-verifier', 'dev-checker'],  // Dépend de diff-verifier et dev-checker
      'ci-tester': ['dev-checker']   // Dépend de dev-checker
    };
