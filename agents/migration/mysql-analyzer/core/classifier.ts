...
// TableClassifier implementation
export class TableClassifier implements McpAgent, BaseAgent, BusinessAgent, AnalyzerAgent {
  readonly metadata: AgentMetadata = {
    id: 'index',
    type: 'analyzer',
    name: 'TableClassifier',
    version: '1.0.0',
    description: 'Automatically fixed version of TableClassifier',
  };
  ...
  async initialize(): Promise<void> {
    ...
    console.log('TableClassifier initialized');
  }
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing TableClassifier with context: ${JSON.stringify(context)}`);
      ...
      // Résultat fictif
      const results = {
        message: 'TableClassifier executed successfully',
...
import { BusinessAgent } from '@workspaces/pipelineakai/src/core/interfaces/business';

import { AnalyzerAgent } from '@workspaces/pipelineakai/src/core/interfaces/business';
