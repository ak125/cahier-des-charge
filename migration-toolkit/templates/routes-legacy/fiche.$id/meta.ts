...
export const meta: MetaFunction = ({ data, params, location }) => {
  ...
  return [
    ...
    { name: "description", content: fiche.metadonnees.description },
    
    // Mots-clés (toujours utiles pour certains moteurs et l'analyse interne)
    { name: "keywords", content: fiche.metadonnees.keywords },
    
    // URL canonique
    { tagName: "link", rel: "canonical", href: canonicalUrl },
    
    // Open Graph - pour un meilleur partage sur les réseaux sociaux
    { property: "og:title", content: fiche.metadonnees.title },
    { property: "og:description", content: fiche.metadonnees.description },
    { property: "og:url", content: canonicalUrl },
    { property: "og:type", content: "article" },
    
    // Twitter Card
    { name: "twitter:card", content: "summary" },
    { name: "twitter:title", content: fiche.metadonnees.title },
    { name: "twitter:description", content: fiche.metadonnees.description },
