/**
 * Pipeline de Migration IA - Workflow Temporal
 * 
 * Ce workflow principal orchestre le pipeline complet d'analyse de code PHP
 * et la génération de code TypeScript/JavaScript en utilisant des modèles IA.
 * Version consolidée des workflows "ai-pipeline-workflow.ts" et "ai-migration-pipeline.workflow.ts"
 */
...
import type * as diagnosticsActivities from '../activities/diagnostics-activities';
