...
export class generate implements McpAgent, BaseAgent, BusinessAgent, GeneratorAgent {
  readonly metadata: AgentMetadata = {
    id: 'generate-migration-plan',
    type: 'analyzer',
    name: 'generate',
    version: '1.0.0',
    description: 'Automatically fixed version of generate',
  };
  ...
  async initialize(): Promise<void> {
    ...
    console.log('generate initialized');
  }
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing generate with context: ${JSON.stringify(context)}`);
