...
export class table implements McpAgent, BaseAgent, BusinessAgent, AnalyzerAgent {
  readonly metadata: AgentMetadata = {
    id: 'table-cartographer',
    type: 'analyzer',
    name: 'table',
    version: '1.0.0',
    description: 'Automatically fixed version of table',
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing table with context: ${JSON.stringify(context)}`);
