...
// php implementation
export class php implements McpAgent , BaseAgent, OrchestrationAgent, BusinessAgent, AnalyzerAgent{
  readonly metadata: AgentMetadata = {
    id: 'php-analyzer.worker',
    type: 'analyzer',
    name: 'php',
    version: '1.0.0',
    description: 'Automatically fixed version of php'
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing php with context: ${JSON.stringify(context)}`);
