...
export class SystemIntegrationBridge
  implements McpAgent, BaseAgent, CoordinationAgent, BridgeAgent, BusinessAgent, AnalyzerAgent
{
  readonly metadata: AgentMetadata = {
...
import {
  BridgeAgent,
  CoordinationAgent,
} from '@workspaces/cahier-des-charge/src/core/interfaces/coordination';
