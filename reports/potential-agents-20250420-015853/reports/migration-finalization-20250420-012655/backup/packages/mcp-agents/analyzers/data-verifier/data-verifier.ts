...
// data implementation
export class data implements McpAgent, BaseAgent, BusinessAgent, AnalyzerAgent {
  readonly metadata: AgentMetadata = {
    id: 'data-verifier',
    type: 'analyzer',
    name: 'data',
    version: '1.0.0',
    description: 'Automatically fixed version of data',
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing data with context: ${JSON.stringify(context)}`);
