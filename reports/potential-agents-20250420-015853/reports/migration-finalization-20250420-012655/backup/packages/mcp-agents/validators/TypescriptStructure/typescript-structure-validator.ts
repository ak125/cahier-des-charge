...
export class TypeScriptStructureValidator
  implements McpAgent, BaseAgent, BusinessAgent, ValidatorAgent
{
  readonly metadata: AgentMetadata = {
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(
        `Executing TypeScriptStructureValidator with context: ${JSON.stringify(context)}`
      );
