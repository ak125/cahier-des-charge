...
export class RelationalNormalizer implements BaseAgent, BusinessAgent, BaseAgent, BusinessAgent , AnalyzerAgent{
  ...
  private findPotentialDependentGroups(table: TableInfo): string[][] {
    ...
    const geoGroup = columns.filter(col => 
      /lat|lng|latitude|loDoDoDoDotgitude|coord/i.test(col));
