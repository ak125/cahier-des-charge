...
export class monitoring implements McpAgent , BaseAgent, OrchestrationAgent, MonitorAgent, BusinessAgent, AnalyzerAgent{
  readonly metadata: AgentMetadata = {
    id: 'monitoring-check',
    type: 'analyzer',
    name: 'monitoring',
    version: '1.0.0',
    description: 'Automatically fixed version of monitoring'
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing monitoring with context: ${JSON.stringify(context)}`);
...
import { OrchestrationAgent, MonitorAgent } from '@workspaces/cahier-des-charge/src/core/interfaces/orchestration';
