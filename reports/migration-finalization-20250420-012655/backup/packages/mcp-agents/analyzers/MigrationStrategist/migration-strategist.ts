...
export class migration implements McpAgent , BaseAgent, BusinessAgent, AnalyzerAgent{
  readonly metadata: AgentMetadata = {
    id: 'migration-strategist',
    type: 'analyzer',
    name: 'migration',
    version: '1.0.0',
    description: 'Automatically fixed version of migration'
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing migration with context: ${JSON.stringify(context)}`);
