...
// sql implementation
export class sql implements McpAgent, BaseAgent, BusinessAgent, AnalyzerAgent {
  readonly metadata: AgentMetadata = {
    id: 'sql-prisma-migration-planner',
    type: 'analyzer',
    name: 'sql',
    version: '1.0.0',
    description: 'Automatically fixed version of sql',
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing sql with context: ${JSON.stringify(context)}`);
