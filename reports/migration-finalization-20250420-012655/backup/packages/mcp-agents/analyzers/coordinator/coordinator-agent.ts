...
export class CoordinatorAgent implements McpAgent , BaseAgent, OrchestrationAgent, BusinessAgent, AnalyzerAgent{
  readonly metadata: AgentMetadata = {
    id: 'coordinator-agent',
    type: 'analyzer',
    name: 'CoordinatorAgent',
    version: '1.0.0',
    description: 'Automatically fixed version of CoordinatorAgent'
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing CoordinatorAgent with context: ${JSON.stringify(context)}`);
