...
export class prisma implements McpAgent , BaseAgent, BusinessAgent, GeneratorAgent{
  readonly metadata: AgentMetadata = {
    id: 'prisma-migration-generator',
    type: 'analyzer',
    name: 'prisma',
    version: '1.0.0',
    description: 'Automatically fixed version of prisma'
  };
  ...
  async execute(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      console.log(`Executing prisma with context: ${JSON.stringify(context)}`);
      ...
      // Résultat fictif
      const results = {
        message: 'prisma executed successfully',
