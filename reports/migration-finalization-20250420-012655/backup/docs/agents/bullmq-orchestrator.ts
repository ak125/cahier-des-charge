 ...
 */
export class BullMqOrchestrator implements BaseAgent, OrchestrationAgent, BaseAgent, OrchestrationAgent {
  ...
  async initialize() {
    ...
    this.schedulers['PhpAnalyzer'] = new QueueScheduler('PhpAnalyzer', { connection: this.redisOptions });
